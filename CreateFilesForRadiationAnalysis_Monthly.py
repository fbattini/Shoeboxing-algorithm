...
def setUpFilesForRadiationAnalysis_Monthly(thisCaseStudyFolderPath, detailedFolderPath):
    ...
    try:
        radiationSimulationFiles_monthly = os.listdir(detailedRadiationMonthlyPath)
    except OSError:
        os.mkdir(detailedRadiationMonthlyPath)
        radiationSimulationFiles_monthly = os.listdir(detailedRadiationMonthlyPath)
    
    if len(radiationSimulationFiles_monthly) == 0:
        ...
        for file in os.listdir(detailedFolderPath):
            if file.endswith(".idf"):
                ...
                idf1.save("{}{}.idf".format(detailedRadiationMonthlyPath, filename))