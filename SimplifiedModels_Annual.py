...
def createSimplifiedModels_Annual(thisCaseStudyFolderPath, detailedFolderPath):
    ...
    for file in os.listdir(detailedFolderPath):
        if file.endswith(".idf"):
            ...
            obstructionRatiosDF = pd.read_csv(detailedRadiationAnalysisAnnualPath + filename + ".csv", index_col = 0)
            ...
            for i in range(len(zones)):
                ...
                northOR = obstructionRatiosDF.iloc[0, 0+i*4]
                eastOR  = obstructionRatiosDF.iloc[0, 1+i*4]
                southOR = obstructionRatiosDF.iloc[0, 2+i*4]
                westOR  = obstructionRatiosDF.iloc[0, 3+i*4]
                ...
                if floorAR == 0:
                    ...
                    thisSurfaceAdiabaticBase = round(thisSurfaceAdiabaticArea/thisSurfaceHeight)
            ...
            idf1.save(simplifiedModelsAnnualPath + filename + "_Simplified.idf")
